  ...
  container.innerHTML = `
    ...
    ">
      ...
      <p style="margin: 10px 0 0 0; font-size: 14px;">
        ${cardData.providerInfo.name || "Your Name"} 
        ${cardData.providerInfo.phone ? `(${cardData.providerInfo.phone})` : ""}
        ${
    ...
    ">
      <div style="
        ...
        font-weight: bold;
      ">
        ${cardData.targetAudience || "Pet Services Available"}
      </div>
      <p style="margin: 0; font-size: 12px; opacity: 0.9;">
        ${cardData.generalInclusions || "Professional pet care services"}
      </p>
    </div>
  `;
